...
export function shapeTrustExplanation({ subjectId, resolution, snapshot, recentEvents }) {
  return {
    ...
    resolution: {
      ...
      trust_state: resolution.trust_state ?? "UNKNOWN",
      trust_vector: resolution.trust_vector ?? null,
      trust_policy: resolution.trust_policy ?? null,
      trust_evidence: resolution.trust_evidence ?? null,
