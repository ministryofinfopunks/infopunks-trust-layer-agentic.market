...
function normalizeX402Diagnostics(value) {
  ...
  return {
    ...
    cdp_payment_payload_has_accepted: normalizeBoolean(value.cdp_payment_payload_has_accepted),
    cdp_payment_payload_has_payload: normalizeBoolean(value.cdp_payment_payload_has_payload),
    cdp_payment_payload_has_resource: normalizeBoolean(value.cdp_payment_payload_has_resource),
    cdp_payment_payload_resource_type: normalizeString(value.cdp_payment_payload_resource_type),
    cdp_payment_payload_accepted_keys: normalizeStringArray(value.cdp_payment_payload_accepted_keys),
    cdp_payment_payload_accepted_has_amount: normalizeBoolean(value.cdp_payment_payload_accepted_has_amount),
    cdp_payment_payload_accepted_has_maxAmountRequired: normalizeBoolean(value.cdp_payment_payload_accepted_has_maxAmountRequired),
    cdp_payment_payload_source: normalizeString(value.cdp_payment_payload_source),
    cdp_payment_requirements_keys: normalizeStringArray(value.cdp_payment_requirements_keys),
    cdp_payment_requirements_has_amount: normalizeBoolean(value.cdp_payment_requirements_has_amount),
    cdp_payment_requirements_has_maxAmountRequired: normalizeBoolean(value.cdp_payment_requirements_has_maxAmountRequired),
    cdp_payment_requirements_amount: normalizeString(value.cdp_payment_requirements_amount),
    cdp_payment_requirements_resource: normalizeString(value.cdp_payment_requirements_resource),
    cdp_payment_requirements_source: normalizeString(value.cdp_payment_requirements_source),
