...
function sanitizePublicX402Diagnostics(value) {
  ...
  return {
    ...
    cdp_payment_payload_keys: toSafeStringArray(value.cdp_payment_payload_keys),
    cdp_payment_payload_has_accepted: toSafeBoolean(value.cdp_payment_payload_has_accepted),
    cdp_payment_payload_has_payload: toSafeBoolean(value.cdp_payment_payload_has_payload),
    cdp_payment_payload_has_resource: toSafeBoolean(value.cdp_payment_payload_has_resource),
    cdp_payment_payload_resource_type: toSafeString(value.cdp_payment_payload_resource_type),
    cdp_payment_payload_accepted_keys: toSafeStringArray(value.cdp_payment_payload_accepted_keys),
    cdp_payment_payload_accepted_has_amount: toSafeBoolean(value.cdp_payment_payload_accepted_has_amount),
    cdp_payment_payload_accepted_has_maxAmountRequired: toSafeBoolean(value.cdp_payment_payload_accepted_has_maxAmountRequired),
    cdp_payment_payload_source: toSafeString(value.cdp_payment_payload_source),
    cdp_payment_requirements_keys: toSafeStringArray(value.cdp_payment_requirements_keys),
    cdp_payment_requirements_has_amount: toSafeBoolean(value.cdp_payment_requirements_has_amount),
    cdp_payment_requirements_has_maxAmountRequired: toSafeBoolean(value.cdp_payment_requirements_has_maxAmountRequired),
    cdp_payment_requirements_amount: toSafeString(value.cdp_payment_requirements_amount),
    cdp_payment_requirements_resource: toSafeString(value.cdp_payment_requirements_resource),
    cdp_payment_requirements_source: toSafeString(value.cdp_payment_requirements_source),
