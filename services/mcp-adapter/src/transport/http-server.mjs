...
function sanitizePublicX402Diagnostics(value) {
  ...
  return {
    ...
    cdp_payment_payload_has_scheme: toSafeBoolean(value.cdp_payment_payload_has_scheme),
    cdp_payment_payload_scheme: toSafeString(value.cdp_payment_payload_scheme),
    cdp_payment_payload_network: toSafeString(value.cdp_payment_payload_network),
    cdp_payment_payload_stripped_wrapper_fields: toSafeBoolean(value.cdp_payment_payload_stripped_wrapper_fields),
